...
const styles = {
  section:
    "py-20 relative bg-gradient-to-b from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-950",
...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Learn how to create a stunning portfolio website using Next.js, Tailwind CSS, and Framer Motion animations.",
    date: "2024-01-15",
    readingTime: "8 min",
  ...
  },
  {
    ...
    excerpt:
      "Discover advanced techniques for optimizing React applications using hooks and memoization.",
    date: "2024-01-10",
    readingTime: "12 min",
    category: "React",
    image: "/placeholder-blog.jpg",
...
const BlogCard = memo(function BlogCard({ post }: { post: BlogPost }) {
  return (
    <motion.article
      ...
      viewport={{ once: true }}
      className="overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-neutral-800"
    >
      ...
      <div className="p-6">
        ...
        <a
          href={post.link}
          className="inline-flex items-center gap-2 text-blue-500 transition-colors hover:text-blue-600"
...
export function BlogSection() {
  ...
  return (
    <section id="blog" className={styles.section} aria-label="Blog posts">
      <div className={styles.container}>
        <motion.div {...headingAnimation} className={styles.header}>
